...
#define ST7735_RES_Pin       GPIO_PIN_3  // RES PA3
#define ST7735_RES_GPIO_Port GPIOA
#define ST7735_CS_Pin        GPIO_PIN_4  // CS PA4
#define ST7735_CS_GPIO_Port  GPIOA
#define ST7735_DC_Pin        GPIO_PIN_6  // DC/RS PA6
...
void ST7735_WriteString(uint16_t x, uint16_t y, char* str, FontDef font, uint16_t color, uint16_t bgcolor);
...
void ST7735_DrawLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t RGBCode);
